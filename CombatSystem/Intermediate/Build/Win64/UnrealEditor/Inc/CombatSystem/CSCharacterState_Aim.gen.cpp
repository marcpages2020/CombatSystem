...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_AimMaxWalkSpeed_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_AimMaxWalkSpeed;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCSCharacterState_Aim_Statics::NewProp_AimMaxWalkSpeed_MetaData[] = {
		{ "Category", "Aim" },
		{ "ModuleRelativePath", "Public/Actions/CSCharacterState_Aim.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCSCharacterState_Aim_Statics::NewProp_AimMaxWalkSpeed = { "AimMaxWalkSpeed", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCSCharacterState_Aim, AimMaxWalkSpeed), METADATA_PARAMS(Z_Construct_UClass_UCSCharacterState_Aim_Statics::NewProp_AimMaxWalkSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCSCharacterState_Aim_Statics::NewProp_AimMaxWalkSpeed_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCSCharacterState_Aim_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCSCharacterState_Aim_Statics::NewProp_AimMaxWalkSpeed,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CombatSystem_Source_CombatSystem_Public_Actions_CSCharacterState_Aim_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCSCharacterState_Aim, UCSCharacterState_Aim::StaticClass, TEXT("UCSCharacterState_Aim"), &Z_Registration_Info_UClass_UCSCharacterState_Aim, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCSCharacterState_Aim), 3041714777U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_CombatSystem_Source_CombatSystem_Public_Actions_CSCharacterState_Aim_h_1393870804(TEXT("/Script/CombatSystem"),
